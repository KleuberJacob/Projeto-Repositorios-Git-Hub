...
export default function Repositorio({match}){
    ...
    useEffect(() => {//Primeira requisição quando monta o componente
    ...
    useEffect(() => {//Para nova requisição quando da alteração das páginas
    ...
    return(
        <Container>
            ...
            <BackButton to='/'>
                <FaArrowLeft color="#000" size={35}></FaArrowLeft>
            </BackButton>
